...
def cache_checkout_data(request):
    try:
        ...
        messages.error(request, "Oh Noo! Looks like we're having problems \
            prosessing your payment right now! Please try again later...")
...
def checkout_complete(request, order_number):
    ...
    messages.success(request, f'Your order has been successful! \
